...
const SECTION_CONFIGS: StageSectionConfig[] = [
  ...
  },
  {
    ...
    subtitle: 'Motivo e recuperação',
    fields: [
      { key: 'no_show_reason', label: 'Motivo do No-show' },
      { key: 'recovery_path', label: 'Caminho de Recuperação' },
      { key: 'next_step_choice', label: 'Próximo Passo (Escolha)' },
      { key: 'next_step', label: 'Próximo Passo' },
      { key: 'attempt_count', label: 'Tentativas' },
      { key: 'call_datetime', label: 'Data/Hora da Ligação' },
      { key: 'visit_datetime', label: 'Data/Hora da Visita' },
      { key: 'address', label: 'Endereço' },
      { key: 'reference_point', label: 'Ponto de Referência' },
    ],
  },
  {
    key: 'negociacao',
